...
* **Beta feature**: We've also added an option to enable [Full Building Propagation](https://docs.hamina.com/kb/basics/heatmaps#full-building-propagation-beta). By default, Hamina shows propagation from the floor above and the floor below the currently selected floor. This helps keep performance pretty fast without sacrificing any accuracy in most environments, but can be limiting in multi-floor environments with lots of floor holes, such as stadiums and arenas.
* **Special feature preview**: Export to Cisco DNA Center! This feature isn't done yet, but we wanted to show you our progress. It probably won't work at all, but [feel free to give it a try](https://docs.hamina.com/kb/import-export/cisco-dna-center).
